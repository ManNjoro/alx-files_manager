...
fileQueue.process(async (job) => {
  ...
  if (!essentials.isValidId(fileId) || !essentials.isValidId(userId)) throw new Error('File not found');
...
userQueue.process(async (job) => {
  ...
  if (!essentials.isValidId(userId)) throw new Error('User not found');
